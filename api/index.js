...
if (globalThis.__vercelTrace) {
  ...
  for (const f of [
    ...
    new URL('../public/img/products/reach-grabber.jpg', import.meta.url),
    new URL('../public/img/products/talking-pill-organizer.jpg', import.meta.url),
    new URL('../public/img/products/led-handheld-magnifier.jpg', import.meta.url),
    new URL('../public/img/products/bed-shaker-alarm-clock.jpg', import.meta.url),
